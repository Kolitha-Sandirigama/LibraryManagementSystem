<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookCategoryManagement.aspx.cs" MasterPageFile="~/MasterPage.Master" Inherits="AuthenticationWeb.MasterDataWeb.BookCategoryManagement" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">

</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="breadcrumb">Book Category</div>

    <div class="divGroup">
    <table class="cs1">
        <tr>
            <th colspan="3" style="font-size:small">
                Book Category Detail</th>
        </tr>
        <tr>
    ...
    <%if(hdnBookCategoryGridVisible.Value == "1"){ %>
    <div class="divGroup">
    <table class="cs1">
        <tr>
            <th colspan="3" style="font-size:small">
                Book Category Summary</th>
        </tr>
        <tr>
            <td colspan="3">
                &nbsp;</td>
        ...
        <tr>
            <td colspan="3">
                <asp:GridView ID="gvBookCategory" runat="server" 
                    AutoGenerateColumns="False" 
                    AllowPaging="True" onpageindexchanging="gvBookCategory_PageIndexChanging" 
                    PageSize="5"   onselectedindexchanging="gvBookCategory_SelectedIndexChanging" >
                    <Columns>
                        <asp:TemplateField>
                            <EditItemTemplate>
                            ...
                            <ItemTemplate>
                                <asp:HiddenField ID="BookCategoryUID" runat="server" Value='<%# Bind("bookCategoryUID") %>' />
                            </ItemTemplate>
                         </asp:TemplateField>
        ...
        <tr>
            <td>
                <asp:HiddenField ID="hdnBookCategoryUID" runat="server" />
                <asp:HiddenField ID="hdnBookCategoryGridVisible" runat="server" />
            </td>
